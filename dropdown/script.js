...
let {iphone} = {iphone}
console.log({iphone})
console.log( {iphone,xiomi,realme,samsung})
const telephone = {
  Samsung: [
    "GalaxyS77",
    "samsung_Galaxy_S46",
  ...
  Apple: ["iPhone7", "iPhone8", "iPhone8Plus", "iPhoneX", "iPhone11"],
  Xiomi: ["RedmiA2", "Redmi10:", "Redmi11", "Redmi12", "Redmi13", "Redmi13c"],
  Realme: ["RealmiNote50", "RealmeC67", "RealmeC53", "Realme9", "Realme9i"],
};
function populateModels() {
  ...
  if (selectedBrand) {
    const models = telephone[selectedBrand];
...
function search() {
  ...
  if (selectedBrand && selectedModel) {
    document.getElementById(
      "result"
    ).innerHTML = `Selected Brand: ${selectedBrand}, Selected Model: ${selectedModel}`;
  } else {
